...
class ReportLabPdf:
    ...
    def _disclaimer_panel(self, styles: dict[str, ParagraphStyle]) -> Table:
        table = Table(
            [
                [Paragraph("AI-generated review", styles["CoverDisclaimerLabel"])],
                [
                    Paragraph(
                        "This report has not been reviewed by Punk Security for technical accuracy.",
    ...
    def _draw_page(canvas, doc):
        ...
        if not page_is_cover:
            canvas.setFillColor(PRINT_MUTED)
